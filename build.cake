    ...
    .Does(() =>
{
    ...
    {
        RunCoverageForTestProject("./test/Stubble.Extensions.SystemData.Tests/Stubble.Extensions.SystemData.Tests.csproj");

        if (AppVeyor.IsRunningOnAppVeyor)
        {
            foreach(var file in GetFiles("./test/Stubble.Extensions.SystemData.Tests/TestResults/*"))
            {
        ...
        testAction("./test/Stubble.Extensions.SystemData.Tests/Stubble.Extensions.SystemData.Tests.csproj")(Context);
    }
});
